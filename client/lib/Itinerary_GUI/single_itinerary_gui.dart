...
class SingleItineraryPage extends StatefulWidget {
  ...
  @override
  _SingleItineraryPageState createState() => _SingleItineraryPageState();
}
...
class _SingleItineraryPageState extends State<SingleItineraryPage> {
        ...
        child: Column(
          children: [
            ...
            Align(
              ...
              child: Text(
                Global().myItinerary.value[widget.index].reviews![index].body,
                style: TextStyle(
  ...
  Widget _interestPointCard(int index, Map<int, int> _point) {
    int _id =
        Global().myItinerary.value[widget.index].interestPoint![index].typology;
  ...
  Widget _generateStar(bool isSingle, int index) {
    ...
    if (isSingle) {
      value = Global().myItinerary.value[widget.index].reviews![index].star;
    } else {
      for (int i = 0;
          i < Global().myItinerary.value[widget.index].reviews!.length;
          i++) {
        value += Global().myItinerary.value[widget.index].reviews![i].star;
      }
      value /= Global().myItinerary.value[widget.index].reviews!.length;
    }
